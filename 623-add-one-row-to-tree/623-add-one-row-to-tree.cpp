...
// class Solution {
// public:
//     void rec(TreeNode* curr, int val, int depth, int count, TreeNode* root){
//         if(curr == nullptr) return;
//         count++;
//         if(count == depth-1){
//             TreeNode* le = new TreeNode(val, curr->left, nullptr);
//             curr->left = le;
//             TreeNode* ri = new TreeNode(val, nullptr, curr->right);
//             curr->right = ri;
//             return;
//         }
//         if(count == depth){
//             TreeNode* le = new TreeNode(val, curr, nullptr);
//             root = le;
//             return;
//         }
//         rec(curr->left, val, depth, count, root);
//         rec(curr->right, val, depth, count, root);
        
//     }
//     TreeNode* addOneRow(TreeNode* root, int val, int depth) {
//         rec(root, val, depth, 0, root);
//         return root;
//     }
// };